...
import {DeepPartial, DistributiveArray, UnionToIntersection} from 'chart.js/dist/types/utils.js';

import {TimeUnit} from 'chart.js/dist/core/core.adapters.js';
import PointElement from 'chart.js/dist/elements/element.point.js';
import {EasingFunction} from 'chart.js/dist/helpers/helpers.easing.js';
import {AnimationEvent} from 'chart.js/dist/types/animation.js';
import {AnyObject, EmptyObject} from 'chart.js/dist/types/basic.js';
import {Color} from 'chart.js/dist/types/color.js';
import Element from 'chart.js/dist/core/core.element.js';
import {ChartArea, Padding, Point} from 'chart.js/dist/types/geometric.js';
import {LayoutItem, LayoutPosition} from 'chart.js/dist/types/layout.js';
import {ColorsPluginOptions} from 'chart.js/dist/plugins/plugin.colors.js';

export {EasingFunction} from 'chart.js/dist/helpers/helpers.easing.js';
export {default as ArcElement, ArcProps} from 'chart.js/dist/elements/element.arc.js';
export {default as PointElement, PointProps} from 'chart.js/dist/elements/element.point.js';
export {Animation, Animations, Animator, AnimationEvent} from 'chart.js/dist/types/animation.js';
export {Color} from 'chart.js/dist/types/color.js';
export {ChartArea, Point} from 'chart.js/dist/types/geometric.js';
export {LayoutItem, LayoutPosition} from 'chart.js/dist/types/layout.js';
