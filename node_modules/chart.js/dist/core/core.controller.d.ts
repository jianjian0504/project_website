...
export type ChartEvent = import('chart.js/dist/types/index.js').ChartEvent;
export type Point = import('chart.js/dist/types/index.js').Point;
declare class Chart {
    ...
    chartArea: any;
    _active: any[];
    _lastEvent: import("chart.js/dist/types/index.js").ChartEvent;
    _listeners: {};
     ...
     * @pravate
     */
    _getActiveElements(e: ChartEvent, lastActive: import('chart.js/dist/types/index.js').ActiveElement[], inChartArea: boolean, useFinalPosition: boolean): import('chart.js/dist/types/index.js').ActiveElement[];
}
