export default class Scale extends Element<import("chart.js/dist/types/basic.js").AnyObject, import("chart.js/dist/types/basic.js").AnyObject> {
     ...
     */
    getLabelItems(chartArea?: import("chart.js/dist/types.js").ChartArea): import('chart.js/dist/types.js').LabelItem[];
    beforeLayout(): void;
    beforeUpdate(): void;
    /**
...
export type Chart = import('chart.js/dist/types/index.js').Chart;
export type Tick = {
    value: number | string;
    label?: string;
    major?: boolean;
